...
//
//   (default)       dist/countdown.mjs
//   umd / umd-min   dist/countdown.js, dist/countdown.min.js
...
const TARGETS = {
  production: { entry: 'src/index.ts', base: 'countdown', format: 'es' },
  umd: { entry: 'src/umd.ts', base: 'countdown', format: 'umd' },
  'umd-min': { entry: 'src/umd.ts', base: 'countdown', format: 'umd' },
  jquery: { entry: 'src/jquery.ts', base: 'jquery.countdown', format: 'es' },
  'jquery-umd': {
    entry: 'src/jquery-umd.ts',
    base: 'jquery.countdown',
    format: 'umd',
  },
  'jquery-umd-min': {
    entry: 'src/jquery-umd.ts',
  ...
  return {
    build: {
      ...
      lib: {
        ...
        name: target.base === 'countdown' ? 'Countdown' : 'countdownJQuery',
